    ...
    <div class="page-header container notfound-container">
        <div class="min-wrapper notfound-wrapper">
            <div class="notfound-text">
                ...
                <h2>
                    <div class="top-about-text-h2 pc">
                        <div class="title-h2 hidden"><span class="slideUp"><span>資料ダウンロード</span></span></div>
                    </div>
            ...
            <figure class="notfound-img fadeUp">
                <img src="[ss_path]/pages/download/smart-fisheries-img01.png"
                    srcset="[ss_path]/img/pages/download/smart-fisheries-img01.png 1x, [ss_path]/img/pages/download/smart-fisheries-img01@2x.png 2x"
                    alt="point image">
            </figure>
        </div>
    </div>
